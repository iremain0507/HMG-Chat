...
export function ComposerPopover({
  ...
  return (
    <div
      ...
      className="absolute bottom-full left-0 z-10 mb-2 flex w-[360px] flex-col overflow-hidden rounded-[10px] border border-border bg-surface shadow-[0_4px_8px_rgba(0,0,0,0.08)]"
    >
      {query !== undefined && (
