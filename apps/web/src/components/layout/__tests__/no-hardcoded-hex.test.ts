// P13-T6-01 회귀 가드 — 핸드오프 정렬 대상 파일에 하드코딩 hex(#rgb/#rrggbb) 0 개.
//   시맨틱 토큰(bg-primary 등)만 사용해야 하며 임의 hex 값은 globals.css 토큰으로만 등록한다.
...
describe("P13-T6-01 하드코딩 hex 제로 회귀 가드", () => {
